...
Naklonujte si repozitář [cviceni-kviz](https://github.com/Czechitas-podklady-WEB/cviceni-kviz) s kostrou stránky pro kvízové otázky. Napište JavaScriptový program, který vybere element s třídou `question` a nastaví jeho obsah na nějakou kvízovou otázku, například
